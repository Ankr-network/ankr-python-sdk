...
# PLEASE FILE AN ISSUE ON https://github.com/Asphere-xyz/ankr-python-sdk/issues
...
class GetBlocksReply:
    def __init__(self, blocks: List[Any], syncStatus: SyncStatus = None):
        self.blocks = blocks
    ...
    def from_dict(cls, **data):
        return cls(
            blocks=[Any.from_dict(**any_data) for any_data in data.get("blocks", [])],
            syncStatus=(
                SyncStatus.from_dict(**data.get("syncStatus"))
...
class GetBlocksRequest:
    def __init__(
        ...
        fromBlock: (
            float | Literal[Literal["latest"]] | Literal[Literal["earliest"]]
        ) = None,
        toBlock: (
            float | Literal[Literal["latest"]] | Literal[Literal["earliest"]]
        ) = None,
...
class GetTransactionsByHashReply:
    def __init__(self, transactions: List[Any], syncStatus: SyncStatus = None):
    ...
    def from_dict(cls, **data):
        return cls(
            transactions=[
                Any.from_dict(**any_data) for any_data in data.get("transactions", [])
            ],
            syncStatus=(
                SyncStatus.from_dict(**data.get("syncStatus"))
                if data.get("syncStatus") is not None
...
class GetTransactionsByAddressReply:
    def __init__(
        self, nextPageToken: str, transactions: List[Any], syncStatus: SyncStatus = None
    ):
...
class Log:
    ...
    def from_dict(cls, **data):
        return cls(
            ...
            event=(
                Event.from_dict(**data.get("event"))
...
class GetNFTMetadataReply:
    ...
    def from_dict(cls, **data):
        return cls(
            metadata=(
                NftMetadata.from_dict(**data.get("metadata"))
                if data.get("metadata") is not None
                else None
            ),
            attributes=(
                NftAttributes.from_dict(**data.get("attributes"))
...
class ExplainTokenPriceSinglePair:
    ...
    def from_dict(cls, **data):
        return cls(
            ...
            token0=(
                ExplainTokenPriceTokenDetails.from_dict(**data.get("token0"))
                if data.get("token0") is not None
                else None
            ),
            token1=(
                ExplainTokenPriceTokenDetails.from_dict(**data.get("token1"))
